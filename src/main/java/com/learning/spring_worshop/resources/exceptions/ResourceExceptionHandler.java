package com.learning.spring_worshop.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> ErrorNotFound(ResourceNotFoundException e, HttpServletRequest request){
